...
public class ExamHistoryActivity extends AppCompatActivity implements ModelTestAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CustomHeaderInt(this, "Exam History");
    ...
    private void parseExam(){
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, Constants.MODEL_TEST_HISTORY+SharedPrefManager.getInstance(this).getUsernameHash()+"&page=0", null,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (!response.getBoolean("error")) {
                                ...
                                modelTestAdapter = new ModelTestAdapter(ExamHistoryActivity.this, modelTestItems);
                                rvCategoryLectures.setAdapter(modelTestAdapter);
                                modelTestAdapter.setOnItemClickListener(ExamHistoryActivity.this);
                            } else {
                                isAutoLoad = response.getBoolean("scroll");
                            }
    ...
    private void getAutoLoad() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, Constants.MODEL_TEST_HISTORY+SharedPrefManager.getInstance(this).getUsernameHash()+"&page="+pageIndex, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
    ...
    public void onItemClick(int position) {
        if (modelTestItems.size() > 0){
            ...
            Intent intent = new Intent(ExamHistoryActivity.this, ExamHistoryViewActivity.class);
